      ...
      <div className="container mx-auto px-6">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-6xl font-bold mb-6">
            <span className="gradient-text">Have an idea?</span>
          </h2>
          ...
          <div className="space-y-8">
            ...
            <div className="glass-effect rounded-2xl p-8">
              <div className="flex items-center space-x-4 mb-6">
                <div className="w-16 h-16 bg-gradient-to-r from-ider-yellow to-yellow-400 rounded-full flex items-center justify-center">
                  <Mail className="w-8 h-8 text-ider-dark" />
                </div>
                <div>
                  <h3 className="text-2xl font-bold text-white">Get In Touch</h3>
                  <p className="text-ider-grey">Drop us a line anytime</p>
                </div>
              </div>
              <a
            ...
            <div className="space-y-6">
              {[
                ...
                <div key={index} className="flex items-start space-x-4">
                  <div className="w-12 h-12 bg-gradient-to-r from-ider-yellow to-yellow-400 rounded-full flex items-center justify-center flex-shrink-0">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white placeholder-ider-grey focus:outline-none focus:border-ider-yellow focus:ring-2 focus:ring-ider-yellow/20 transition-all duration-300"
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  rows={5}
                  className="w-full px-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white placeholder-ider-grey focus:outline-none focus:border-ider-yellow focus:ring-2 focus:ring-ider-yellow/20 transition-all duration-300 resize-none"
              ...
              <button
                type="submit"
                className="w-full bg-ider-yellow text-ider-dark py-4 rounded-lg font-bold text-lg hover:bg-yellow-400 transition-all duration-300 neon-glow group"
              >
